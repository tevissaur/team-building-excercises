...
This application allows the user to create a webpage for their team that displays the team member's name, role, ID, email, and any unique data for their role. 
  ...
  - Clone to machine
  - Run `npm i` and `npm start` to run script.
  ## <a id="usage"></a> Usage

- Run all necessary commands
- Answer all prompts
- Open your webpage in your preferred browser
